...
def draw_on_off_button(x, y, state):
    ...
    button_rect = pygame.Rect(x, y, 70, 35)
...
def main_menu(current_language_index):
    ...
    while True:
        ...
        if(current_language_index == 0):
            ...
            CONFIG_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/settings.png"), (75,75)), pos=(screen_resolution.get_width() * 0.045, screen_resolution.get_height() / 1.080), 
                                text_input="", font=get_font(75), base_color="#d7fcd4", hovering_color="White")  # Ícone de engrenagem, sem texto
            HISTORY_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/iconehistorico.png"), (75,75)), pos=(screen_resolution.get_width() * 0.960, screen_resolution.get_height() / 1.080), 
...
def play(current_language_index):
    ...
    while True:
        ...
        SETTINGS_GELADEIRA = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.40, screen_resolution.get_height() / 4.3), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        
        SETTINGS_CAFETEIRA = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.40, screen_resolution.get_height() / 2.80), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        
        SETTINGS_CHUVEIRO = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.40, screen_resolution.get_height() / 2.1), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        SETTINGS_TERMOMETRO = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.40, screen_resolution.get_height() / 1.70), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        SETTINGS_SENSOR = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.40, screen_resolution.get_height() / 1.42), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pygame.Rect(button_x, button_y_start, 70, 35).collidepoint(event.pos):
                    toggle_on_off_button_geladeira()
