...
resolutions = [(640, 480), (800, 600), (1024, 768), (1280, 720), (1920, 1080), "Fullscreen"]
screen_resolution = pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
pygame.display.set_caption("Eden")

BG = pygame.image.load("assets/fundoeden2.png")

def get_font(size): 
    return pygame.font.Font("assets/LucidaTypewriterBold.ttf", size)

def draw_horizontal_line(color):
    pygame.draw.line(screen_resolution, color, (0, screen_resolution.get_height() / 1.5), (screen_resolution.get_width(), screen_resolution.get_height() / 1.5), 5)
...
def draw_on_off_button(x, y, state):
    ...
    # Desenha o botão
    pygame.draw.rect(screen_resolution, button_color, button_rect)
...
def draw_notification(screen_resolution, message):
    ...
    pygame.draw.rect(notification_surface, (255, 0, 0), button_rect)
...
def main_menu(current_language_index):
    ...
    while True:
        ...
        MENU_TEXT = get_font(150).render("EDEN", True, "#000000")
        MENU_RECT = MENU_TEXT.get_rect(center=(screen_resolution.get_width() / 2, screen_resolution.get_height() / 6))

        draw_horizontal_line(line_color)
        if(current_language_index == 0):
            DISPOSITIVOS_BUTTON = Button(image=pygame.image.load("assets/dispositivosrect.png"), pos=(screen_resolution.get_width() * 0.40, screen_resolution.get_height() / 2), 
                                text_input="Dispositivos", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
            CONFIG_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/settings.png"), (75,75)), pos=(screen_resolution.get_width() * 0.025, screen_resolution.get_height() / 1.050), 
                                text_input="", font=get_font(75), base_color="#d7fcd4", hovering_color="White")  # Ícone de engrenagem, sem texto
            HISTORY_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/iconehistorico.png"), (75,75)), pos=(screen_resolution.get_width() * 0.973, screen_resolution.get_height() / 1.045), 
                                text_input="", font=get_font(75), base_color="#d7fcd4", hovering_color="White") 
            QUIT_BUTTON = Button(image=pygame.image.load("assets/Sair.png"), pos=(screen_resolution.get_width() * 0.70, screen_resolution.get_height() / 2), 
                                text_input="SAIR", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
            
        elif(current_language_index == 1):
            DISPOSITIVOS_BUTTON = Button(image=pygame.image.load("assets/devicerect.png"), pos=(screen_resolution.get_width() * 0.40, screen_resolution.get_height() / 2), 
                                text_input="Devices", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
            CONFIG_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/settings.png"), (75,75)), pos=(screen_resolution.get_width() * 0.025, screen_resolution.get_height() / 1.050), 
                                text_input="", font=get_font(75), base_color="#d7fcd4", hovering_color="White")  # Ícone de engrenagem, sem texto
            HISTORY_BUTTON = Button(image=pygame.transform.scale(pygame.image.load("assets/iconehistorico.png"), (75,75)), pos=(screen_resolution.get_width() * 0.973, screen_resolution.get_height() / 1.045), 
                                text_input="", font=get_font(75), base_color="#d7fcd4", hovering_color="White") 
        ...
        if pygame.time.get_ticks() - color_timer >= 1000:
            line_color = pygame.Color('black')
...
def play(current_language_index):
    ...
    while True:
        ...
        button_y_start = screen_resolution.get_height() / 2 - 200  # Ajuste para centralizar verticalmente e espaço entre os botões

        if (current_language_index == 0):

            PLAY_TEXT = get_font(100).render("Dispositivos", True, "Black")
            PLAY_RECT = PLAY_TEXT.get_rect(center=(screen_resolution.get_width() / 2, screen_resolution.get_height() / 8))
            ...
            geladeira_text = get_font(50).render("Geladeira", True, (0, 0, 0))
            screen_resolution.blit(geladeira_text, (button_x + 110, button_y_start))

            # Desenha o botão on/off para a cafeteira
            draw_on_off_button(button_x, button_y_start + 70, on_off_state_cafeteira)
            cafeteira_text = get_font(50).render("Cafeteira", True, (0, 0, 0))
            screen_resolution.blit(cafeteira_text, (button_x + 110, button_y_start + 70))

            # Desenha o botão on/off para o chuveiro
            draw_on_off_button(button_x, button_y_start + 140, on_off_state_chuveiro)
            chuveiro_text = get_font(50).render("Chuveiro", True, (0, 0, 0))
            screen_resolution.blit(chuveiro_text, (button_x + 110, button_y_start + 140))

            # Desenha o botão on/off para o termômetro
            draw_on_off_button(button_x, button_y_start + 210, on_off_state_termometro)
            termometro_text = get_font(50).render("Termômetro", True, (0, 0, 0))
            screen_resolution.blit(termometro_text, (button_x + 110, button_y_start + 210))

            # Desenha o botão on/off para o sensor
            draw_on_off_button(button_x, button_y_start + 280, on_off_state_sensor)
            sensor_text = get_font(50).render("Sensor", True, (0, 0, 0))
            screen_resolution.blit(sensor_text, (button_x + 110, button_y_start + 280))
            ...
            PLAY_TEXT = get_font(100).render("Devices", True, "Black")
            PLAY_RECT = PLAY_TEXT.get_rect(center=(screen_resolution.get_width() / 2, screen_resolution.get_height() / 8))
            screen_resolution.blit(PLAY_TEXT, PLAY_RECT)
            # Desenha o botão on/off para a geladeira
            draw_on_off_button(button_x, button_y_start, on_off_state_geladeira)
            geladeira_text = get_font(50).render("Fridge", True, (0, 0, 0))
            screen_resolution.blit(geladeira_text, (button_x + 110, button_y_start))

            # Desenha o botão on/off para a cafeteira
            draw_on_off_button(button_x, button_y_start + 70, on_off_state_cafeteira)
            cafeteira_text = get_font(50).render("Coffee", True, (0, 0, 0))
            screen_resolution.blit(cafeteira_text, (button_x + 110, button_y_start + 70))

            # Desenha o botão on/off para o chuveiro
            draw_on_off_button(button_x, button_y_start + 140, on_off_state_chuveiro)
            chuveiro_text = get_font(50).render("Shower", True, (0, 0, 0))
            screen_resolution.blit(chuveiro_text, (button_x + 110, button_y_start + 140))

            # Desenha o botão on/off para o termômetro
            draw_on_off_button(button_x, button_y_start + 210, on_off_state_termometro)
            termometro_text = get_font(50).render("Thermometer", True, (0, 0, 0))
            screen_resolution.blit(termometro_text, (button_x + 110, button_y_start + 210))
        ...
        SETTINGS_GELADEIRA = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.58, screen_resolution.get_height() / 2.90), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        
        SETTINGS_CAFETEIRA = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.58, screen_resolution.get_height() / 2.43), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        
        SETTINGS_CHUVEIRO = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.58, screen_resolution.get_height() / 2.1), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        SETTINGS_TERMOMETRO = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.58, screen_resolution.get_height() / 1.85), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        SETTINGS_SENSOR = Button(image=pygame.transform.scale(pygame.image.load("assets/info.png"), (48,48)), pos=(screen_resolution.get_width() / 1.58, screen_resolution.get_height() / 1.65), 
                            text_input="", font=get_font(75), base_color="Black", hovering_color="Green")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pygame.Rect(button_x, button_y_start, 100, 50).collidepoint(event.pos):
                    toggle_on_off_button_geladeira()
                # Verifica se o botão on/off da cafeteira foi clicado
                elif pygame.Rect(button_x, button_y_start + 70, 100, 50).collidepoint(event.pos):
                    toggle_on_off_button_cafeteira()
                # Verifica se o botão on/off do chuveiro foi clicado
                elif pygame.Rect(button_x, button_y_start + 140, 100, 50).collidepoint(event.pos):
                    toggle_on_off_button_chuveiro()
                # Verifica se o botão on/off do termômetro foi clicado
                elif pygame.Rect(button_x, button_y_start + 210, 100, 50).collidepoint(event.pos):
                    toggle_on_off_button_termometro()
                # Verifica se o botão on/off do sensor foi clicado
                elif pygame.Rect(button_x, button_y_start + 280, 100, 50).collidepoint(event.pos):
...
def config(current_language_index):
    while True:
        ...
        if(current_language_index == 0):
            ...
            CONFIG_TEXT = get_font(100).render("Configurações", True, "Black")
            ...
            LANGUAGE_BUTTON = Button(image=None, pos=(screen_resolution.get_width() / 2.14, screen_resolution.get_height() * 0.4), 
        ...
        if(current_language_index == 1):
            ...
            CONFIG_TEXT = get_font(100).render("Settings", True, "Black")
            CONFIG_RECT = CONFIG_TEXT.get_rect(center=(screen_resolution.get_width() / 2, screen_resolution.get_height() / 8))
            screen_resolution.blit(CONFIG_TEXT, CONFIG_RECT)
            LANGUAGE_BUTTON = Button(image=None, pos=(screen_resolution.get_width() / 2.14, screen_resolution.get_height() * 0.4), 
...
def resolution_settings(screen_resolution, current_resolution_index, Fullscreen, current_language_index):
    while True:
        ...
        for i, res in enumerate(resolutions):
            ...
            # Caixa de seleção
            checkbox_rect = pygame.Rect(checkbox_x, checkbox_y, 20, 20)
            pygame.draw.rect(screen_resolution, color, checkbox_rect, 2)
            
            # Marcar caixa de seleção se for a resolução atual
            if i == current_resolution_index and Fullscreen == 0:
                pygame.draw.line(screen_resolution, color, (x_mark_x, x_mark_y), (x_mark_x + 10, x_mark_y + 10), 2)
                pygame.draw.line(screen_resolution, color, (x_mark_x + 10, x_mark_y), (x_mark_x, x_mark_y + 10), 2)
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if event.button == 1:  # Clique com o botão esquerdo do mouse
                    ...
                    if resolutions[selected_index] == "Fullscreen":
                        ...
                        screen_resolution = pygame.display.set_mode(resolutions[current_resolution_index])
        pygame.display.update()

def language_settings(current_language_index):
    while True:
        LANG_MOUSE_POS = pygame.mouse.get_pos()
        ...
        for i, lang in enumerate(languages):
            ...
            if i == current_language_index:
                pygame.draw.line(screen_resolution, color, (checkbox_x + 5, checkbox_y + 5), (checkbox_x + 15, checkbox_y + 15), 2)
                pygame.draw.line(screen_resolution, color, (checkbox_x + 15, checkbox_y + 5), (checkbox_x + 5, checkbox_y + 15), 2)
...
def history(current_language_index):
    while True:
        ...
        screen_resolution.fill("#FFF4EE")
        if current_language_index == 0:
            SPEC1_TEXT = get_font(100).render("Histórico", True, "Black")
            ...
            SPEC1_TEXT = get_font(100).render("History", True, "Black")
            SPEC1_RECT = SPEC1_TEXT.get_rect(center=(screen_resolution.get_width() / 2, screen_resolution.get_height() / 8))
            screen_resolution.blit(SPEC1_TEXT, SPEC1_RECT)
...
def especificacao2(current_language_index):
    while True:
        SPEC2_MOUSE_POS = pygame.mouse.get_pos()
...
def options(current_language_index):
    ...
    while True:
        ...
        grafico1_img = pygame.image.load("assets/grafico1.png")
        if grafico1_img.get_rect(topleft=(screen_resolution.get_width() * 0.15, screen_resolution.get_height() * 0.2)).collidepoint(OPTIONS_MOUSE_POS):
            grafico1_img.fill((0, 255, 0, 128), special_flags=pygame.BLEND_RGBA_MULT)

        screen_resolution.blit(grafico1_img, (screen_resolution.get_width() * 0.15, screen_resolution.get_height() * 0.2))

        grafico2_img = pygame.image.load("assets/grafico2.png")
        if grafico2_img.get_rect(topleft=(screen_resolution.get_width() * 0.7, screen_resolution.get_height() * 0.2)).collidepoint(OPTIONS_MOUSE_POS):
            grafico2_img.fill((0, 255, 0, 128), special_flags=pygame.BLEND_RGBA_MULT)

        screen_resolution.blit(grafico2_img, (screen_resolution.get_width() * 0.7, screen_resolution.get_height() * 0.2))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if grafico2_img.get_rect(topleft=(screen_resolution.get_width() * 0.7, screen_resolution.get_height() * 0.2)).collidepoint(event.pos):
